 ...
 */
final class Version20240211143612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE message (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, chat_id INTEGER DEFAULT NULL, user_id INTEGER DEFAULT NULL, message VARCHAR(255) NOT NULL, type INTEGER NOT NULL, url VARCHAR(255) NOT NULL, pin_message VARCHAR(255) NOT NULL, time INTEGER NOT NULL, CONSTRAINT FK_B6BD307F1A9A7125 FOREIGN KEY (chat_id) REFERENCES chat (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B6BD307FA76ED395 FOREIGN KEY (user_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
